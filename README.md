...
All the implementations are root are manually generated or from a build process
located in the [.dev/](.dev) directory. They should each come with their own 
instructions.

Anyway for running anything python you will need a python interepeter and a
virtual environment with the expected dependencies specified in the 
[pyproject.toml](pyproject.toml).

This requirements can easily be satisfied by using [uv](https://docs.astral.sh/uv/):
